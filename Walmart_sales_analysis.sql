...
select time_of_date, count(*) as total_sales  from sales where day_name = "Sunday" group by time_of_date order by total_sales desc;
...
select gender, count(*) as gender_cnt from sales where branch = "C" group by gender order by gender_cnt;
select gender, count(*) as gender_cnt from sales where branch = "A" group by gender order by gender_cnt;
select gender, count(*) as gender_cnt from sales where branch = "B" group by gender order by gender_cnt;

-- Which time of the day do customers give most ratings?----------------
select time_of_date, avg(rating) as avg_rating from sales group by time_of_date order by avg_rating desc;

-- Which time of the day do customers give most ratings per branch?
select time_of_date, avg(rating) as avg_rating from sales where branch = "B" group by time_of_date order by avg_rating desc;
...
select day_name, round(avg(rating), 2) as avg_rating from sales where branch= "B"  group by day_name order by avg_rating desc; 
